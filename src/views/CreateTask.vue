...
<div>
    ...
    <nav>
      <a href="javascript:;" @click="goBack">
          <span class="icon-svg">
            ...
            <path id="Page_1" data-name="Page 1" d="M5.8,9.2a.793.793,0,0,1-1.121,1.121L.263,5.913a.9.9,0,0,1,0-1.268L4.675.233A.793.793,0,0,1,5.8,1.354L1.871,5.279Z" transform="translate(0.5 0.5)" fill="#b0bec5" stroke="#b0bec5" stroke-miterlimit="10" stroke-width="1"/>
            </svg>
          </span>
        {{ title }}
      </a>
  ...
  <main>
    ...
    <div class="create__task">
      ...
      <textarea  cols="30" rows="10" placeholder="here write detail task" v-model="task.body" ></textarea>
    </div>
  </main>
  <footer>
    <button class="navigation__button" @click="addTask">
        <span class="icon-svg">
...
export default {
  ...
  methods:{
    ...
    goBack(){
      this.$router.push({name : 'Category',params:{slug : this.categoryId}})
    },
    idGenerator(){
